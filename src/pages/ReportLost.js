      ...
      <div className="container mx-auto px-4 max-w-3xl py-8">
        <div className="relative overflow-hidden bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 rounded-2xl shadow-xl mb-6 border border-gray-700">
          <div className="absolute inset-0 opacity-20">
            ...
            <div className="absolute bottom-0 right-0 w-72 h-72 bg-rose-500 rounded-full mix-blend-multiply filter blur-3xl animate-pulse delay-1000"></div>
          </div>
        ...
        >
          ...
          <div className="flex gap-3">
            ...
            <button
              ...
              className={`flex-1 bg-gradient-to-r from-red-500 to-rose-600 text-white py-3 rounded-xl font-semibold transition ${
                loading || uploading
